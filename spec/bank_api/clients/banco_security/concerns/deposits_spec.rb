  ...
  context "with deposits from account details" do
    ...
    it "returns deposits" do
      expect(dummy.deposits_from_account_details).to eq(
        [
          {
            client: "EMILIO JOSE PLAZA DE LOS REYES QUIEROZ",
            rut: nil,
